# [Assayo NPX](https://bakhirev.github.io/?ref=github-npx)
...
**Ссылки:** [demo](https://bakhirev.github.io/demo/?ref=npx&dump=./test.txt), [online version](https://bakhirev.github.io/demo/?ref=npx), [docker](https://hub.docker.com/r/bakhirev/assayo), [reddit](https://www.reddit.com/r/ITManagers/comments/1e5k291/the_visualization_and_analysis_of_git_commit/), [habr](https://habr.com/ru/articles/852782/).
...
**Основное приложение:** [github](https://github.com/bakhirev/assayo), [website](https://bakhirev.github.io/?ref=npx)
...
<a href="https://bakhirev.github.io/demo/?dump=./test.txt" target="_blank"><img src="https://bakhirev.github.io/seo/github/index.gif" width="100%" /></a>
...
Если упал с любой ошибкой (например, нет версии пакета), то обновляем авторизацию:
1. Логинимся на https://www.npmjs.com/ (Audi TT)
2. Идем в раздел токенов https://www.npmjs.com/settings/bakhirev/tokens/
  3. Выпускаем новый с галочкой "пропуск двух факторной авторизации"
  4. Ставим "разрешить менять любой пакет"
  5. Выпускаем токен
6. Прописываем токен у себя в глобал npmrc, типа:
```
//registry.npmjs.org/:_authToken=......
```
7. Сбрасываем кеш ```npm cache clean --force```
8. Пробуем публикацию снова.
...
2. требует токен;
3. настоящий токен длинный, а в UI отображается короткий на ~20 символов;
4. может случайно отваливаться;
5. токен может умереть и нужно будет создать новый;
```
